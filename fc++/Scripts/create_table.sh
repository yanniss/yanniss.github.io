...
echo \<p\>\<font size=+1\>$dir single file download\:\<\/font\>
echo \<ul\>	
echo \<li\>
echo As a \<a href=\"$dir.tar\"\>tar file\<\/a\>\<\/li\>
echo \<li\> 
echo As a \<a href=\"$dir.tar.gz\"\>gzipped tar file\<\/a\>\<\/li\>
echo \<li\>
echo As a \<a href=\"$dir.zip\"\>zip file\<\/a\>\<\/li\>
echo \<\/ul\>
echo \<hr WIDTH=\"100%\"\>
