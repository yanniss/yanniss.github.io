...
public class aspecttest {
	public static void main(String[] myargs)  {
		...
		AspectDec aspect2 = new AspectDec(null, "Foo", null, null, null, null, new Decs(new Dec[] {pdec1, adv1, pdec1, var1, meth1}));
