...
public class test1 {
	public static void main(String[] myargs)  {
		...
		ASTObject pack2 = new Identifier(new Identifier(new Identifier("java"), new Identifier("lang")), (Identifier)pack1);
		...
		TypeD type9 = (TypeD)type1;
		TypeD type10 = new ArrayTypeD((TypeD)type1);
		...
		ASTObject expr1 = new Identifier("foo");
		...
		ASTObject expr10 = new PostfixExpr(new Identifier("foo"), "--");
		...
		ASTObject expr19NumericOpExpr = new NumericOpExpr(new IntLiteralExpr(1), "*", new IntLiteralExpr(3)), "-", new NumericOpExpr(new IntLiteralExpr(4), "/", new IntLiteralExpr(2));
		ASTObject expr20 = new ShiftOpExpr(new IntLiteralExpr(1), ">>", new VarExpr(new Identifier("foo")));
		ASTObject expr21 = new NumericTestOpExpr(new IntLiteralExpr(1), ">", new IntLiteralExpr(1));
